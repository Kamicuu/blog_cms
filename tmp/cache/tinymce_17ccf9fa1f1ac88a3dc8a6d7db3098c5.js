...
tinymce.init({
	...
	cmsms_tiny: cmsms_tiny = {
			...
			linker_image : 'http://localhost/modules/TinyMCE/lib/images/cmsmslink.gif',
			linker_url : 'http://localhost/admin/moduleinterface.php?mact=TinyMCE,m1_,linker,0&__c=948878f5124373ee471&showtemplate=false',
			linker_autocomplete_url : 'http://localhost/admin/moduleinterface.php?mact=TinyMCE,m1_,ajax_getpages,0&__c=948878f5124373ee471&showtemplate=false',
	...
	autoresize_bottom_margin: 10,
			...
			external_filemanager_path:"http://localhost/modules/TinyMCE/responsive_filemanager/filemanager/",
	  	filemanager_title: "File manager",
		filemanager_access_key: "e2527d62e58f4627ffd016db7c60b4f7",
	...
	external_plugins: {
					"cmsms_linker" : "http://localhost/modules/TinyMCE/lib/js/tinymce_external_plugins/cmsms_linker/plugin.js",
							"filemanager" : "http://localhost/modules/TinyMCE/responsive_filemanager/filemanager/plugin.min.js",
			"responsivefilemanager" : "http://localhost/modules/TinyMCE/responsive_filemanager/tinymce_plugin/responsivefilemanager/plugin.min.js",
			},
