...
?>
        <div class="pageoverflow">
          <p class="pagetext"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['fld']->value[0])===null||$tmp==='' ? '' : $tmp);?>
</p>
          <p class="pageinput"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['fld']->value[1])===null||$tmp==='' ? '' : $tmp);
if (isset($_smarty_tpl->tpl_vars['fld']->value) && count($_smarty_tpl->tpl_vars['fld']->value) == 3) {?><br/><?php echo (($tmp = @$_smarty_tpl->tpl_vars['fld']->value[2])===null||$tmp==='' ? '' : $tmp);
}?></p>
        </div>
        <?php
}
