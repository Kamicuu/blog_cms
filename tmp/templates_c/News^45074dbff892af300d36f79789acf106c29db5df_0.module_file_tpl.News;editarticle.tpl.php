<?php
/* Smarty version 3.1.31, created on 2022-05-18 12:41:52
  from "module_file_tpl:News;editarticle.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_6284cd70b58629_84946806',
...
function content_6284cd70b58629_84946806 (Smarty_Internal_Template $_smarty_tpl) {
...
if (!is_callable('smarty_function_html_select_date')) require_once 'D:\\ROZNE\\blog_cms\\lib\\smarty\\plugins\\function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) require_once 'D:\\ROZNE\\blog_cms\\lib\\smarty\\plugins\\function.html_select_time.php';
if (!is_callable('smarty_cms_function_cms_yesno')) require_once 'D:\\ROZNE\\blog_cms\\lib\\plugins\\function.cms_yesno.php';
if (!is_callable('smarty_function_cms_textarea')) require_once 'D:\\ROZNE\\blog_cms\\lib\\plugins\\function.cms_textarea.php';
if (!is_callable('smarty_function_thumbnail_url')) require_once 'D:\\ROZNE\\blog_cms\\lib\\plugins\\function.thumbnail_url.php';
if (!is_callable('smarty_function_cms_filepicker')) require_once 'D:\\ROZNE\\blog_cms\\admin\\plugins\\function.cms_filepicker.php';
echo '<script'; ?>
...
title" value="<?php echo mb_convert_encoding(htmlspecialchars($_smarty_tpl->tpl_vars['title']->value, ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8');?>
...
extra" value="<?php echo smarty_modifier_cms_escape($_smarty_tpl->tpl_vars['extra']->value);?>
...
"><?php echo smarty_modifier_cms_escape($_smarty_tpl->tpl_vars['field']->value->prompt);?>
